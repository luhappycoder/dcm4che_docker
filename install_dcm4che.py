...
r = os.system(
    f"""echo "1.3.12.2.1107.5.9.1:ImplicitVRLittleEndian;ExplicitVRLittleEndian" >>{DEST}/dcm4che-{VERSION}/etc/getscu/store-tcs.properties"""
)

# allow the getscu client to download CFMM's 9.4T data.
r = os.system(
    f"""echo 'EnhancedMRImageStorage:ImplicitVRLittleEndian;ExplicitVRLittleEndian'>>{DEST}/dcm4che-{VERSION}/etc/getscu/store-tcs.properties"""
)
